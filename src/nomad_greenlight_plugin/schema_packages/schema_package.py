...
from nomad.metainfo.data_type import m_float64, m_str
        ...
        if create_objects:
            try:
                quantities[col] = Quantity(
                    type=type_dict[col], shape=['*'], unit=units[col]
                )
            except (pint.errors.UndefinedUnitError, ValueError, AttributeError):
                quantities[col] = Quantity(
                    type=type_dict[col], shape=['*'], unit='dimensionless'
                )
        else:
            quantities[col] = (
                f"Quantity(type={type_dict[col]}, shape=['*'], unit='{units[col]}')\n"
            )
    return quantities
    ...
    with open(quantity_file, 'w') as file:
        if create_objects:
            for key, value in quantities.items():
                file.write(
                    f"{key} = Quantity(type={value.type}, shape=['*'], "
                    f"unit='{value.unit}')\n"
                )
        else:
            for key, value in quantities.items():
...
class GreenlightSchemaPackage(PlotSection, Schema):
    ...
    anode_inlet_rel_hum_calc = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    anode_recipe_selector = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    anode_total_reactant_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    cathode_inlet_rel_hum = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    cathode_inlet_rel_hum_calc = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    cathode_recipe_selector = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    cathode_total_reactant_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    concentration_anode_h2 = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_anode_h2_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_anode_n2 = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_anode_n2_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_cathode_air = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_cathode_air_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_cathode_n2 = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    concentration_cathode_n2_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    current_density = Quantity(
        type=m_float64(), shape=['*'], unit='ampere / centimeter ** 2'
    )
    ...
    current_ramping_enable_flag = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    cv01_apex_scan_rate_set = Quantity(
        type=m_float64(), shape=['*'], unit='volt / second'
    )
    ...
    cv01_final_scan_rate_set = Quantity(
        type=m_float64(), shape=['*'], unit='volt / second'
    )
    ...
    cv01_initial_scan_rate_set = Quantity(
        type=m_float64(), shape=['*'], unit='volt / second'
    )
    ...
    deltat_temp_coolant_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    deltat_temp_coolant_diff_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    ...
    eis01_estimated_z_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    eis01_points_per_decade_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    eis01_sample_mode_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    eis01_single_frequency_set = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    flow_anode_h2_mfc_total = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_anode_h2_mfc_total_set = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_anode_n2_mfc_total = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_anode_n2_mfc_total_set = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_cathode_air_mfc_total = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_cathode_air_mfc_total_set = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_cathode_n2_mfc_total = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    flow_cathode_n2_mfc_total_set = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    ...
    gas_purge_manual_request = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    heater_anode_dewpoint_a_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_dewpoint_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_dewpoint_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_endplate_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_endplate_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_heattape_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_heattape_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_humid_outlet_heattape_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_anode_humid_outlet_heattape_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_dewpoint_a_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_dewpoint_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_dewpoint_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_endplate_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_endplate_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_heattape_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_heattape_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_humid_outlet_heattape_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    heater_cathode_humid_outlet_heattape_ssr = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    heaters_overtemp_shutdown = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    level_alarm_disable = Quantity(type=m_float64(), shape=['*'], unit='dimensionless')
    level_anode_humid_high = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    level_anode_humid_low = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    level_cathode_humid_high = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    level_cathode_humid_low = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    pressure_anode_bpc_disable = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_anode_cathode_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_anode_coolant_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_anode_in_out_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_anode_inlet = Quantity(type=m_float64(), shape=['*'], unit='dimensionless')
    pressure_anode_inlet_absolute = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_anode_inlet_error = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_anode_lock_diff_limit = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_anode_lock_in_transition = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_anode_min_lock = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_anode_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    pressure_cathode_coolant_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_cathode_in_out_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_cathode_inlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_cathode_inlet_absolute = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_cathode_inlet_error = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_cathode_lock_diff_limit = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_cathode_lock_in_transition = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_cathode_min_lock = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_cathode_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    pressure_coolant_in_out_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_coolant_inlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_coolant_inlet_absolute = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_coolant_inlet_error = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_coolant_lock_diff_limit = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_coolant_lock_in_transition = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_coolant_min_lock = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_coolant_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_coolant_set = Quantity(type=m_float64(), shape=['*'], unit='dimensionless')
    pressure_lock_cathode = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_lock_coolant = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_lock_lines_selection = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_lock_pause_flag = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_lock_ramp_diff = Quantity(type=m_float64(), shape=['*'], unit='kilopascal')
    pressure_lock_ramp_step = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_lock_set = Quantity(type=m_float64(), shape=['*'], unit='dimensionless')
    pressure_lock_step_timeout = Quantity(
        type=m_float64(), shape=['*'], unit='millisecond'
    )
    pressure_nitrogen_supply = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_stack_compression = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_stack_compression_diff = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_stack_compression_diff_limit = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_stack_compression_inlet_error = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pressure_stack_compression_lock_in_transition = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pressure_stack_compression_min_lock = Quantity(
        type=m_float64(), shape=['*'], unit='kilopascal'
    )
    pump_anode_dewpoint_on = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    pump_cathode_dewpoint_on = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    safeguard_flag_purging = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    scattergraph_add_point = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    scattergraph_clear_plot = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    scattergraph_profile_name = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    scattergraph_remove_point = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    scattergraph_sample_size = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    scattergraph_save_file = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    signal_in_h2_sensor_second = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_in_relay_fs_alarm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_in_relay_lvs_alarm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    signal_in_zero_volt_pws_fault = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    signal_out_flow_coolant_ip = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_out_light_green = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_out_light_red = Quantity(type=m_float64(), shape=['*'], unit='dimensionless')
    signal_out_pressure_anode_ip = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_out_pressure_cathode_ip = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_out_pressure_coolant_ip = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    signal_out_pressure_stack_compression_ip = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    temp_anode_cathode_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_coolant_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_dewpoint = Quantity(type=m_float64(), shape=['*'], unit='degree_Celsius')
    temp_anode_dewpoint_heattape_ts = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_anode_dewpoint_puckheater_a_tsh = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_anode_dewpoint_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_dewpoint_water = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_endplate = Quantity(type=m_float64(), shape=['*'], unit='degree_Celsius')
    temp_anode_endplate_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_gas_inlet_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_heattape = Quantity(type=m_float64(), shape=['*'], unit='degree_Celsius')
    temp_anode_humid_outlet_heattape = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_humid_outlet_heattape_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_humid_outlet_heattape_ts = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_anode_in_out_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_anode_inlet = Quantity(type=m_float64(), shape=['*'], unit='degree_Celsius')
    temp_anode_inlet_heattape_ts = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_anode_outlet = Quantity(type=m_float64(), shape=['*'], unit='degree_Celsius')
    temp_cathode_coolant_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_dewpoint = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_dewpoint_heattape_ts = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_cathode_dewpoint_puckheater_a_tsh = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_cathode_dewpoint_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_dewpoint_water = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_endplate = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_endplate_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_gas_inlet_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_heattape = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_humid_outlet_heattape = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_humid_outlet_heattape_set = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_humid_outlet_heattape_ts = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_cathode_in_out_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_cathode_inlet = Quantity(type=m_float64(), shape=['*'], unit='degree_Celsius')
    temp_cathode_inlet_heattape_ts = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    temp_coolant_heater_tsh = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    temp_coolant_hex_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    temp_coolant_in_out_diff = Quantity(
        type=m_float64(), shape=['*'], unit='degree_Celsius'
    )
    ...
    total_anode_stack_flow = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    total_anode_stack_flow_set = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    total_cathode_stack_flow = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    total_cathode_stack_flow_set = Quantity(
        type=m_float64(), shape=['*'], unit='liter / minute'
    )
    valve_anode_dewpoint_hex_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_dewpoint_hex_outlet_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_dry_bypass = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_h2_mfc_high = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_humid_drain = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_humid_fill = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_humid_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_n2_mfc_high = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_anode_n2_purge = Quantity(type=m_float64(), shape=['*'], unit='dimensionless')
    valve_cathode_air_mfc_high = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_dewpoint_hex_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_dewpoint_hex_outlet_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_dry_bypass = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_humid_drain = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_humid_fill = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_humid_outlet = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_n2_mfc_high = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_cathode_n2_purge = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    ...
    valve_di_coolant_hex_out = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
    valve_di_coolant_hex_out_pwm = Quantity(
        type=m_float64(), shape=['*'], unit='dimensionless'
    )
